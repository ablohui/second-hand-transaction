			                ...
			                -->
			                    ...
			                    <table id="fresh-table" class="table spancolor">
			                        <thead>
			                        	...
			                        	<th data-field="redate" >注册时间</th>
			                        </thead>
			                        <tbody>
			                        <% ArrayList list=(ArrayList)session.getAttribute("User_Select_List"); 
			                          if(list!=null){
			                        	  for(int i=0;i<list.size();i++){
			                        		 ...
			                        		 <tr class="tdcolor">
				                            	<td ><span><%=user.getUid() %></span></td>
				                            	<td><span><%=user.getUsername() %></span></td>
				                            	<td><span><%=user.getTelephone() %></span></td>
				                            	<td><span><%=user.getQQ() %></span></td>
				                            	<td><span><%=user.getAlipay()%></span></td>
				                            	<td><span><%=user.getRedate()%></span></td>
			                           		 </tr>
			                        ...
			                        %>
			                            ...
			                            <tr>
			                            	<td><span>2</span></td>
			                            	<td><span>2</span> </td>
			                            	<td><span>$23,789</span></td>
			                            	<td><span>Curaçao</span></td>
			                            	<td><span>Sinaai-Waas</span></td>
			                            	<td></td>
			                            </tr>
			                            <tr>
			                            	<td>3</td>
