<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
     <%@ page import="java.sql.*,com.yh.valuebeen.*,java.util.*" %>
...
<section id="main-content">
	<section class="wrapper">
		...
		ArrayList<shop> list=(ArrayList<shop>)session.getAttribute("Select_Image_List");
		rs.last();
		int i=rs.getRow();
		System.out.print(i);
		int count=i/3-1;
		...
		<!-- gallery -->
	<div class="gallery">
		<h2 class="w3ls_head">商品图片</h2>
		<div class="gallery-grids">
		<%for(;count>0;count--){ %>
				<div class="gallery-top-grids">
				  <%for(int j=0;j<3;j++) {
					  m++;
				  shop shop=list.get(m);
					...
					<div class="col-sm-4 gallery-grids-left">
						<div class="gallery-grid">
							<a class="example-image-link" href="#" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vitae cursus ligula">
								<img src="../user/<%=shop.getImage() %>" alt="" />
								<div class="captn">
									<h4><%=shop.getShopname() %></h4>
									<p><%=shop.getShoptime() %></p>
								</div>
							</a>
						</div>
					</div>
