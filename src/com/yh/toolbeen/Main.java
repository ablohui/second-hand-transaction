...
public class Main {
    ...
    static {
        ...
        /** 濡傛灉闇�瑕佸湪绋嬪簭涓鐩朇onfigs鎻愪緵鐨勯粯璁ゅ弬鏁�, 鍙互浣跨敤ClientBuilder绫荤殑setXXX鏂规硶淇敼榛樿鍙傛暟 鍚﹀垯浣跨敤浠ｇ爜涓殑榛樿璁剧疆 */
    ...
    public void test_monitor_sys() {
        ...
        AlipayHeartbeatSynRequestBuilder builder = new AlipayHeartbeatSynRequestBuilder()
            ...
            .setNetworkType("LAN").setProviderId("2088122187736674") // 璁剧疆绯荤粺鍟唒id
    ...
    public void test_monitor_pos() {
        ...
        AlipayHeartbeatSynRequestBuilder builder = new AlipayHeartbeatSynRequestBuilder()
            ...
            .setManufacturerPid("2017092908985973")
            // 濉啓鏈哄叿鍟嗙殑鏀粯瀹漰id
    ...
    public void test_trade_pay(AlipayTradeService service) {
        ...
        // (鍙�夛紝鏍规嵁闇�瑕佸喅瀹氭槸鍚︿娇鐢�) 璁㈠崟鍙墦鎶橀噾棰濓紝鍙互閰嶅悎鍟嗗骞冲彴閰嶇疆鎶樻墸娲诲姩锛屽鏋滆鍗曢儴鍒嗗晢鍝佸弬涓庢墦鎶橈紝鍙互灏嗛儴鍒嗗晢鍝佹�讳环濉啓鑷虫瀛楁锛岄粯璁ゅ叏閮ㄥ晢鍝佸彲鎵撴姌
        // 濡傛灉璇ュ�兼湭浼犲叆,浣嗕紶鍏ヤ簡銆愯鍗曟�婚噾棰濄��,銆愪笉鍙墦鎶橀噾棰濄�� 鍒欒鍊奸粯璁や负銆愯鍗曟�婚噾棰濄��- 銆愪笉鍙墦鎶橀噾棰濄��
